...
## Adding Images to Footer (or Anywhere in Docs)

To add an image in Mintlify Markdown, use the following syntax:

```md
![Alt text for accessibility](https://example.com/image-url.jpg)
```
